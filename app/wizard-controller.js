(function wizardControllerModule() {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .wizard-goal-priorities {
        display: grid;
        grid-template-columns: repeat(3, minmax(0, 1fr));
        gap: 10px;
      }
      .wizard-goal-priority {
        display: grid;
        gap: 6px;
        color: var(--text-secondary, #a0aab2);
        font-size: var(--font-size-small, .75rem);
      ...
      .wizard-goal-priority select:focus { border-color: var(--blue, #3a93ff); }
      .wizard-option {
        min-width: 0;
        min-height: 48px;
        padding: 11px;
      ...
      .wizard-program span { min-width: 0; overflow-wrap: anywhere; }
      .wizard-program span:last-child { color: var(--text-secondary, #a0aab2); white-space: normal; }
      .wizard-footer {
        display: flex;
        justify-content: space-between;
        gap: 10px;
      ...
      @media (max-width: 560px) {
        ...
        .wizard-options, .wizard-fields, .wizard-goal-priorities { grid-template-columns: 1fr; }
