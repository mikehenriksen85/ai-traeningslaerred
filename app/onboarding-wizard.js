(function onboardingWizardModule() {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .onboarding-program-row { display: flex; flex-wrap: wrap; justify-content: space-between; gap: 6px 12px; padding: 9px 10px; border-bottom: 1px solid rgba(255, 255, 255, .06); }
      .onboarding-program-row span { min-width: 0; overflow-wrap: anywhere; }
      .onboarding-program-row span:last-child { color: var(--text-secondary, #a0aab2); white-space: normal; }
      ...
      @media (max-width: 560px) {
        ...
        .onboarding-button { flex: 1 1 120px; }
      }
    `;
